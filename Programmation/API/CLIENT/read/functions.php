...
function GetAllClients(){
  $req = "SELECT PERSONNE.PERSONNE_ID as id, PERSONNE.PERSONNE_NOM as last_name, PERSONNE.PERSONNE_PRENOM as first_name, PERSONNE.PERSONNE_MAIL as email, PERSONNE.PERSONNE_TEL as phone FROM PERSONNE WHERE`FK_ROLE_ID` = 2 AND `PERSONNE_ACTIVE` = 1";
  $query = database()->prepare($req);
  $query->execute();
